 ...
 */
public class TrimPrinterVisitor extends DefaultPrettyPrinterVisitor {

    public TrimPrinterVisitor(PrinterConfiguration configuration) {
        super(configuration);
    }

    public TrimPrinterVisitor(PrinterConfiguration configuration, SourcePrinter printer) {
